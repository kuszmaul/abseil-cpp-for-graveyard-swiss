...
using ::absl::container_internal::Alloc;
using ::absl::container_internal::GlobalHashtablezSampler;
using ::absl::container_internal::HashtablezInfo;
using ::absl::container_internal::PairArgs;
using ::absl::container_internal::SetHashtablezEnabled;
using ::absl::container_internal::SetHashtablezSampleParameter;
...
TEST(Table, RehashWithNoResize) {
  ...
  size_t last_key_num_probes = absl::container_internal::GetHashtableDebugNumProbes(t, last_key);
  ...
  while (last_key_num_probes == absl::container_internal::GetHashtableDebugNumProbes(t, last_key)) {
    t.emplace(x);
...
ProbeStats CollectProbeStatsOnKeysXoredWithSeed(
  ...
  while (num_iters--) {
    ...
    auto probe_histogram = absl::container_internal::GetHashtableDebugNumProbesHistogram(t1);
